    ...
    return (
        <div className="home-container">
            <div className="home-content">
                ...
                <h1 className="home-title">Pocket Notes</h1>

                <p className="home-description">Send and receive messages without keeping your phone online.</p>
                <p className="home-description">Use Pocket Notes on up to 4 linked devices and 1 mobile phone</p>
            </div>
            ...
            <div className="home-footer">
                ...
                <p className="home-encryption-text">end-to-end encrypted</p>
            </div>
        </div>
    );
};
