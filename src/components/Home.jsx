...
const Home = () => {
    return (
        <div className='flex flex-col w-3/4 p-8 bg-[#DAE5F5] max-sm:hidden'>
            
            <div className='flex flex-1 flex-col items-center justify-center'>
                <img src={landingPage} width={600} height={300} alt="landing-page" />

                <h1 className='text-6xl font-bold mb-3'>Pocket Notes</h1>

                <p className='font-medium'>Send and receive messages without keeping your phone online.</p>
                <p className='font-medium'>Use Pocket Notes on up to 4 linked devices and 1 mobile phone</p>
            </div>
            
            <div className='flex self-end justify-center gap-2 w-full'>
                ...
                <p className='font-mono'>end-to-end encrypted</p>
            </div>
        </div>
